...
- Impact of Deadlines on Productivity: An article discusses how deadlines can increase study motivation among university students, suggesting that clear deadlines can enhance productivity and task completion. ([PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC10728329))

**Comparables:**
- Slack: A communication platform that facilitates team collaboration. Does not focus on task management or deadline tracking.
- Notion: An all-in-one workspace combining notes, tasks, and databases. Offers flexibility but requires significant customization for academic needs.
- Trello: A popular project management tool that offers task tracking and collaboration features. Not tailored specifically for student group projects; lacks academic context and integration.
...
- Interest in Financial Education: 85% of U.S. high school students are interested in learning about financial topics in school, yet many lack access to such education. ([Intuit](https://www.intuit.com/blog/innovative-thinking/intuit-survey/))

**Comparables:**
- Mint: Free budgeting tool; lacks personalized financial education for young adults.
- YNAB (You Need A Budget): Emphasizes proactive budgeting; steeper learning curve.
- Wally: Tracks expenses and budgets; may lack tailored financial education content.
...
**Evidence:**
- Research Challenges: 70% of postgraduate research students face difficulty understanding statistical information in papers, showing challenges in comprehension. ([PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC10562852/))
- Student Perceptions: Students often struggle to identify relevant academic papers and distinguish scholarly from popular sources. ([In the Library with the Lead Pipe](https://www.inthelibrarywiththeleadpipe.org/2018/it-was-information-based/))
- Literature Review Difficulties: Many students find it challenging to narrow down sources, especially for specific or niche research topics. ([Miami OH LibGuides](https://libguides.lib.miamioh.edu/c.php?g=1438528&p=10714375&utm_source=chatgpt.com))

**Comparables:**
- Connected Papers: Helps explore related papers. Doesn't provide summaries or relevance insights.
- Semantic Scholar: AI-powered search engine; lacks summarization or visualization features.
- Zotero: Reference management software. Doesn't help with discovering new papers or summarizing content.

## Features

1. Student Groups & Club Coordination

- Task Assignment & Deadline Tracking<br>
  **Description:** Allows students to assign tasks to group members with specific deadlines and track progress.  
  **Why It Helps:** Ensures accountability and helps prevent missed deadlines, directly addressing lost tasks.

- Real-Time Collaboration<br>
  **Description:** Enables multiple users to work on tasks simultaneously and see updates in real-time.  
  **Why It Helps:** Improves coordination among group members and reduces misunderstandings.

- Push Notifications & Reminders<br>
  **Description:** Sends notifications and reminders for upcoming deadlines and tasks.  
  **Why It Helps:** Keeps students on track and reduces the likelihood of forgetting important tasks.

---

2. Early Financial Literacy

- Expense Categorization & Budgeting<br>
  **Description:** Automatically categorizes expenses and provides budgeting tools to manage finances.  
  **Why It Helps:** Helps students track spending habits and stick to a budget.

- Financial Goal Setting<br>
  **Description:** Allows users to set financial goals and track progress toward achieving them.  
  **Why It Helps:** Encourages proactive financial planning and helps students stay focused on their financial objectives.

- Integrated Financial Education Resources<br>
  **Description:** Provides access to articles, videos, and tutorials on personal finance topics.  
  **Why It Helps:** Improves financial literacy with easily accessible educational materials.

---

3. Academic Paper Discovery & Summarization

- Paper Summarization & Keyword Tagging<br>
  **Description:** Summarizes academic papers and tags them with relevant keywords for easy reference.  
  **Why It Helps:** Reduces the time spent reading and understanding papers.

- Paper Recommendation Engine<br>
  **Description:** Suggests academic papers based on the user's research interests and past readings.  
  **Why It Helps:** Helps students discover relevant papers more efficiently.

- Peer Review & Feedback System<br>
  **Description:** Facilitates peer reviews and feedback on tasks and assignments.  
  **Why It Helps:** Enhances work quality through constructive criticism and promotes collaborative learning.
